      ...
      <div className="bg-base-100 rounded-md p-4">
        <div className="flex justify-center">
          <ul className="steps">
            ...
            <li
              className={`step ${
                step >= 1 ? "step-neutral before:bg-second" : ""
              }`}
            >
              <span className={`step-icon ${step >= 1 ? "bg-second" : ""}`}>
            ...
            <li
              className={`step ${
                step >= 2 ? "step-neutral before:bg-second" : ""
              }`}
            >
              <span className={`step-icon ${step >= 2 ? "bg-second" : ""}`}>
